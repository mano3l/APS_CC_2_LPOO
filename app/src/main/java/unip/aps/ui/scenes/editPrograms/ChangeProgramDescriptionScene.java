...
public class ChangeProgramDescriptionScene implements Runnable {
    @Override
    public void run() {
        try (Terminal terminal = TerminalBuilder.builder().system(true).build()) {
            ...
            header.add(new AttributedStringBuilder().append(applyStyleTo(" Editar descricao do curso \n", Theme.BLACK, Theme.MAGENTA)).toAttributedString());
        ...
        var programObj = pms.getProgramByCode(result.get("programCode").getResult());
            ...
            if (!pms.isProgramRegistered(programObj)) {
                ...
                promptBuilders
                        ...
                        .message("Digite a nova descricao do curso: ").addPrompt();
                ...
                pms.changeProgramDescription(result.get("programCode").getResult(), results.get("newProgramDescription").getResult());
